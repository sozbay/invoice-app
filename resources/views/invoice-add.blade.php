                        ...
                        <div class="card-body">
                            ...
                            <div class="row p-sm-4 p-0">
                                <div class="col-md-6 col-sm-5 col-12 mb-sm-0 mb-4">
                                    ...
                                    <div class="sonuc">Müşteri Seçiniz</div>

                                </div>
                                <div class="col-md-6 col-sm-7">
                                    <h6 class="mb-4">Havale:</h6>
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td class="pe-4">Toplam Tutar:</td>
                                            <td><strong class="grand-total">0₺</strong></td>
                                            <input type="hidden" value="" class="grand-total-input" name="total_price">
                                            <input type="hidden" value="" class="tax-total-input" name="total_tax">
                                            <input type="hidden" value="" class="discount-total-input" name="total_discount">
                                        </tr>
                                        <tr>
                                        ...
                                        <div class="row w-100 p-3">
                                            <div class="col-md-4 col-12 mb-md-0 mb-3">
                                                ...
                                                <input type="text" class="form-control mb-3" placeholder="Ürün Kodu"
                                                       name="product_code" required="required">
                                                <input type="text" class="form-control mb-3" placeholder="Ürün Adı"
                                                       name="product_name" required="required">
                                                <textarea class="form-control" rows="2"
                                                          placeholder="Ürün Açıklama" name="description" required="required"></textarea>
                                            </div>
                                ...
                                <div class="col-md-12 d-flex justify-content-end">
                                    <div class="invoice-calculations">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="fw-semibold grand-total">0 ₺</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="2" id="note"
                                                  placeholder="Fatura Not" name="note"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function calculateTotal() {
            setTimeout(() => {
                ...
                $('.tax-total-input').val(tax.toFixed(2))
                $('.discount-total-input').val(discount)
                $('.tax-summary').html(tax.toFixed(2) + ' ₺')
                $('.discount-summary').html(discount.toFixed(2) + ' ₺')
